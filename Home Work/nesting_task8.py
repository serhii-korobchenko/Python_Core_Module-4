...
[[1, 1, 5, 10], [10, 2], [1, 1, 1]]
Для этого списка и начальной энергии равной 1, игрок поглотит из первого списка 
первые два значения и покинет его, встретив значение 5, так как на этот момент будет 
обладать энергией в 3. Второй список пропустит сразу, а третий полностью поглотит и 
получит окончательную энергию в 6. """
...
game([[1, 1, 5, 10], [10, 2], [1, 1, 1]], 1) #6
game([[1, 2, 5, 10], [2, 10, 2], [1, 3, 1]], 1) #11
